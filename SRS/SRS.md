...
##### 用户交互设计
 ...
 对于血糖记录，提供按日、周、月等跨度查看的选择。系统默认选项为日，用户也可以自己修改。如果跨度是日，先显示当前月的界面（选择日）；如果是周，则会有一个显示周的界面（选择周），标题仍然是月， 26~2日，3日到9日，10~16日....等等，如果是月，就能直接显示12个月（选择月）。不能选择的日期、月、周显示为灰色，防止用户做出错误的动作。

 血糖记录在开始界面就进行了展示，作为本系统最重要的信息，多次展示也有助于提醒用户。

 对于运动方案，即使没有运动方案，用户也可以运动。运动方案的生成、运动过程中、检测是否符合运动前提条件等等界面均可以被打断，且均有相应警告。当用户不满意生成的运动方案时，可以点击“重新选择”再次选择。

 <img src="https://github.com/SoftwareEngineeringMedical/.github/assets/103842499/8addbf60-b27f-491b-8897-ad57d0f8a351" width="30%">

  对于整体的导航设计，采用了尽量多的跳转按钮，例如在查询血糖的历史记录时，可以点击“选择”再次选择查看的粒度与时间，可以点击“回今天”立马跳转到当前数据，导航关系中适当的冗余有助于增强用户对系统的“掌控感”。

<img src="https://github.com/SoftwareEngineeringMedical/.github/assets/103842499/74cd5367-8e00-4289-8520-30f1887e863f" width="30%">
